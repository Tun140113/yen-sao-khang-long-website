...
export default function MessageBubble({ message }) {
  ...
  return (
    <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
      {!isUser && (
        <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#D4AF37] to-[#B8941E] flex items-center justify-center mt-0.5 flex-shrink-0">
                ...
                components={{
                  code: ({ inline, className, children, ...props }) => {
                    ...
                    return !inline && match ? (
                      ...
                      <code className="px-1 py-0.5 rounded bg-[#F8F5F0] text-[#6B5742] text-xs">
                        {children}
                      </code>
                    );
                  },
                  ...
                  blockquote: ({ children }) => (
                    <blockquote className="border-l-2 border-[#D4AF37] pl-3 my-2 text-[#6B5742]">
                      {children}
                    </blockquote>
                  ),
                }}
